 ...
 */
public class CW08_PlayingWithDigits {
    ...
    public static long digPow(int n, int p) {
        ...
        for (int i = p; i < p + arr.length; i++) {
            sum += (int) Math.pow(Integer.parseInt(arr[i - p]), i);
        }
        return sum % n == 0 ? sum / n : -1;

        // lodimob, Napolithanio, PanDeBatalla94, Jin Romero
