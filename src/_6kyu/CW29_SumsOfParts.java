...
//            result[i] = sumOfPart(ls, i, ls.length - 1, 0);
//        }
//        return result;
//    }
//
//    static int sumOfPart(int[] arr, int left, int right, int sum) {
//        if (left > right) return sum;
//        return sumOfPart(arr, left + 1, right, sum + arr[left]);
//    }
}
