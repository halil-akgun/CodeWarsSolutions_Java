...
Example
Round 1: Frank 2 5 8 11, Sam 1 4 7 10, Tom 0 3 6 9. Tom has to start from 0.
         Frank is risking nothing and goes 2. Sam gets lucky and wins round by throwing 4.
 ...
 */
public class CW04_AnotherCardGame {
    public static void main(String[] args) {
        int[] frank = {0, 1, 2, 3};
        int[] sam = {4, 5, 6, 7};
        int[] tom = {8, 9, 10, 11};
        System.out.println(game(frank, sam, tom));
    }
